            ...
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <ul class="nav nav-pills" role="tablist">
                                <li class="nav-item"><a data-toggle="pill" id="pills-graficos-tab" href="#graficos" class="nav-link  active" role="tab" aria-controls="pills-grafico" aria-selected="true">Gráfico</a></li>
                                <li class="nav-item"><a data-toggle="pill" id="pills-detalles-tab" href="#detalles" class="nav-link" role="tab" aria-controls="pills-detalles" aria-selected="true">Detalles</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-12 col-md-6">
                ...
                <div class="card-body" style="padding:10px">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade" id="detalles" role="tab-panel" aria-labelledby="pills-detalles-tab">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Tabla de detalles</h3>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        @foreach ($secondquery as $item)
                                                            <tr>
                                                                <td>@if($item->precioconsulta != null) Consulta @elseif($item->precioproc != null) {{$item->procnombre}} @else Biopsia @endif</td>
                                                                <td>{{$item->nombre.' '.$item->apellidos}}</td>
                                                                <td>$ @if($item->precioconsulta != null) {{$item->precioconsulta}} @elseif($item->precioproc != null) {{$item->precioproc}} @else {{$item->preciobiopsia}} @endif</td>
                                                                <td>@if($item->estadoconsulta != null) {{$item->estadoconsulta}} @elseif($item->estadoproc != null) {{$item->estadoproc}} @else {{$item->estadobiopsia}} @endif</td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
                        ...
                        <div class="tabe-pane fade " id="graficos" role="tabpanel" aria-labelledby="pills-graficos-tab">
                            <div class="row">
                                <div-col-sm-12 class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Resultados semanales</h3>
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-minus"></i>
                                                </button>
                                                <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fa fa-times"></i></button>
