<form method="POST" action="{{route('pacientes.store')}}" class="form-horizontal">
    @csrf
    <div class="modal fade" id="nuevoPaciente" tabindex="-1" role="dialog" aria-labelledby="nuevoPaciente" aria-hidden="true">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col">
                                <input type="text"   id="email" class="form-control  @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"  autocomplete="email" placeholder="Correo Electrónico">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row form-group">
                            <div class="col">
                                <div class="col form-check form-check-inline" >
                                    <input class="form-check-input " type="radio" name="sexo" checked id="sexoHombre" value="M" required>
                        ...
                        <div class="row form-group">
                            <div class="col">
                                <div class="col form-check form-check-inline" >
                                    <input class="form-check-input " type="radio" checked name="civil" id="soltero" value="Soltero(a)" >
                        ...
                        <div class="row form-group ">
                            <div class="col">
                                <input type="number" class="form-control  @error('estatura') is-invalid @enderror" name="estatura" id="estatura" value="{{ old('estatura') }}" step="0.01"  autocomplete="estatura" autofocus  placeholder="Estatura en m.">
                                @error('estatura')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col">
                                <input type="number" class="form-control  @error('peso') is-invalid @enderror" name="peso" value="{{ old('peso') }}"  autocomplete="peso" step="0.01" placeholder="Peso en Libras.">
                                 @error('peso')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col">
                                <input id="presion" type="text" class="form-control @error('presion') is-invalid @enderror" name="presion"   placeholder="presión en mm Hg">
                                @error('presion')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row form-group ">
                            <div class="col">
                                <input type="number" class="form-control  @error('temperatura') is-invalid @enderror" name="temperatura" value="{{ old('temperatura') }}" step="0.01" autocomplete="temperatura" autofocus placeholder="Temperatura en Cº">
                                    @error('temperatura')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col">
                                <input id="glucosa" type="number" class="form-control @error('glucosa') is-invalid @enderror" name="glucosa" step="0.01"   placeholder="Glucosa en mg/dl">
                                @error('glucosa')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row form-group">
                           <div class="col">
                                <input type="text" name="direccion" id="direccion" class=" form-control @error('direccion') is-invalid @enderror" value="{{ old('direccion') }}" placeholder="Dirección">
