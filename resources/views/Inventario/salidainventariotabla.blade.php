<div class="modal fade " id="salidatabla" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <form action="{{route('entradainventarios.store')}}" method="POST">
                    @csrf                    
                      ...
                      <input type="hidden" name="medicamento_id" id="medicamento" value="">
                    ...
                    <div class="form-group">
                        <label for="fechaexp">Fecha de ingreso de pedido</label>
            ...
            <div class="modal-footer">
                    <div class="form-group pull-right">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary">Agregar pedido</button>
                    </div>
                </form>
            </div>
          </div>
