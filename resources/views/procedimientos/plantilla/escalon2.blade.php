...
<body>
    <div class="header-left">
        ...
        <p class="bold" style="text-transform:uppercase">{{$clinica->nombreClinica}}</p>
        <p class="bold" style="text-transform:uppercase">{{ $procedimiento->doctorinvitado }} {{-- | JVPM {{$doctor->codigoDoctor}} --}}</p>
    </div>
