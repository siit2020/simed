...
<body>
    <table class="header">
        <tr>
            <td width="100"> <img src="{{public_path('adjuntosdoctor/'.$doctor->id.'-'.$doctor->apellidosDoctor.'/'.$doctor->logo)}}" width="100" alt=""> </td>
            <td width="336">
                <h1>{{ $doctor->tituloDoctor }}</h1>
                <h3>{{$clinica->direccion}}</h3>
                <h3>Tels.: {{$clinica->telefonos}} | Cel. {{$clinica->celular}}</h3>
            </td>
            <td width="100"></td>
        </tr>
    </table>
    ...
    <table class="data">
        <tr>
            ...
            <td width="268" colspan="2">
                Procedimiento de: <span>{{ $tipo->procedimiento_nombre }}</span>
            </td>
        </tr>
        <tr>
            <td width="268">
