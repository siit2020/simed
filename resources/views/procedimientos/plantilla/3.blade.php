...
<body>
        ...
        <table class="header">
                <tr>
                    <td> <img src="{{asset('adjuntosdoctor/'.$doctor->id.'-'.$doctor->apellidosDoctor.'/'.$doctor->logo)}}" width="100" alt=""> </td>
                </tr>
                <tr>
                    <td width="496">
            ...
            <table class="data">
                <tr>
                    ...
                    <td width="248" colspan="2">
                        <b>{{ $tipo->procedimiento_nombre }} Número:</b> {{ $procedimiento->id }}
                    </td>
                </tr>
                <tr>
                    <td width="248">
    ...
    <table class="logoss">
        <tr><td> <img src="{{asset('adjuntosdoctor/'.$doctor->id.'-'.$doctor->apellidosDoctor.'/'.$doctor->logo)}}" width="100" alt="" ></td></tr>
    </table>
    <br>
    ...
    <table class="imagenes">
            ...
            <tr>
                <td>
                    <img src="{{public_path()}}/capturas/{{$procedimiento->id.'/'.$img[4]}}" width="300" height="220" alt="">
                </td>
                <td width="12">&nbsp;</td>
                <td>
                    <img src="{{public_path()}}/capturas/{{$procedimiento->id.'/'.$img[5]}}" width="300" height="220" alt="">
                </td>
            </tr>
        </table>
