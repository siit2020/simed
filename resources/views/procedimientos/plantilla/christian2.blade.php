...
<body>
    ...
    <div class="footer-right">
        <p><img src="{{ public_path('procedimientos/plantilla/pacheco/facebook.png') }}" height="14px" > </p>
        <p><img src="{{ public_path('procedimientos/plantilla/pacheco/web-icon.png') }}" height="14px"> </p>
    </div>
    <div class="footer-right-text">
       <a href="https://www.facebook.com/gastrocentro.com.sv/" ><p>{{$clinica->facebook}}</p></a>
        <p>
    ...
    <div class="imgTop">
        <img src="{{public_path()}}/capturas/{{$procedimiento->id.'/'.$img[0]}}" alt="">
        <img src="{{public_path()}}/capturas/{{$procedimiento->id.'/'.$img[1]}}" alt="">
        <img src="{{public_path()}}/capturas/{{$procedimiento->id.'/'.$img[2]}}" alt="">
    </div>

    <div class="imgBottom">
        <img src="{{public_path()}}/capturas/{{$procedimiento->id.'/'.$img[3]}}" alt="">
        <img src="{{public_path()}}/capturas/{{$procedimiento->id.'/'.$img[4]}}" alt="">
        <img src="{{public_path()}}/capturas/{{$procedimiento->id.'/'.$img[5]}}" alt="">
    </div>
