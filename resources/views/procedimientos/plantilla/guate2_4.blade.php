...
<body>
    ...
    <img src="{{ public_path('/adjuntosdoctor/'.$doctor->id.'-'.$doctor->apellidosDoctor.'/logo2.png')}}" class="watermaker" >
    ...
    <div class="footer-right-text">
        <p>SIIMED</p>
        <p>
            <a href="http://107.180.28.153/~ezrwzdx2ax2z">www.siimed.com</a>
        </p>
    </div>
    <div class="fecha">
