...
<body>
    <header>
        ...
        <div class="info-header">
            ...
            <h3 class="doctor">Dr. {{$doctor->nombreDoctor.' '.$doctor->apellidosDoctor}} </h3>
            <h2 class="tituloreporte">Reporte de {{$tipo->procedimiento_nombre }}</h2>
        </div>
    </header>
    <footer>
        <div class="redes">
            <div>
                @if($clinica->celular!=null) <span><img src="{{public_path('iconospdf/whatsapp.png')}}" class="icon" alt="">{{$clinica->celular}}</span>@endif
                @if($clinica->telefonos!=null) <span><img src="{{public_path('iconospdf/telefono.png')}}" class="icon" alt="">{{$clinica->telefonos}}</span>@endif 
    ...
    <main>
        <div class="descripcion">
            <h3><span class="nombre-paciente"><strong>PACIENTE:</strong> {{$pacientes->nombre.' '.$pacientes->apellidos}}</span> <span ><strong class="sexo">SEXO:</strong> @if($pacientes->sexo=='M')Masculino @else Femenino @endif</span><span class="edad"><strong>EDAD:</strong> {{$edad}} años</span></h3>
    ...
    <div class="main2">
            <h3 style="font-size:14px;text-align:center"><span class="nombre-paciente"><strong>PACIENTE:</strong> {{$pacientes->nombre.' '.$pacientes->apellidos}}</span></h3>
      <div class="fotos">
            <table>
                <tr>
