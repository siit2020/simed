...
<body>
    <table class="header">
        <tr>
            <td width="100"> <img src="{{ public_path('procedimientos/plantilla/zablah/logov.png')}}" width="175" height="125" alt=""> </td>
            <td width="336">
                <h1> Dr. Roberto Arturo Zablah C. </h1>
                <h2> Pediatra Gastroenterólogo</h2>

                <h3>{{$doctor->direccion}}</h3>
                <h3> Telefono: 2264-3426 Celular: 7730-5109 Telefax: 2263-5719 </h3>
                <h3> E-mail: consultas@robertozablah.com </h3>
            </td>
            <td width="100"></td>
        </tr>
    </table>
    ...
    <div class="logoSecond">
        <img src="{{ public_path('procedimientos/plantilla/zablah/multipediatrica.jpg')}}" width="90" alt="">
    </div>
</body>
</html>
